/**************************************************************************
 ...
 Description:  Read CPS March 2016 data.
...
libname library "/homes/data/cps";

*  The following line should contain
   the complete path and name of the raw data file.
   On a PC, use backslashes in paths as in C:\	 ;

FILENAME datafile pipe "unzip -p /homes/data/cps/cpsmar2016.zip ";

*  The following line should contain the name of the SAS dataset ;

%let dataset = cpsmar2016 ;
...
attrib  h_livqrt     length=3     label="Item 4 - Type of living quarters (reco";
...
attrib  hunder15     length=3     label="Recode Number of persons in household ";
attrib  hh5to18      length=3     label="Recode Item 82 - Number of persons in ";
attrib  hhotlun      length=3     label="Item 83 - During 20.. how many of the ";
attrib  hhotno       length=3     label="Item 83 - Number of children in househ";
...
attrib  hpublic      length=3     label="Item 88 - Is this a public housing pro";
attrib  hlorent      length=3     label="Item 89 - Are you paying lower rent be";
attrib  hfoodsp      length=3     label="Item 90 - Did anyone in this household";
attrib  hfoodno      length=3     label="Item 91 - Number of children covered b";
attrib  hfoodmo      length=3     label="Item 92 - Number months covered by foo";
attrib  hengast      length=3     label="Item 93 - The gov't has an energy assi";
attrib  hengval      length=4     label="Item 94 - Altogether, how much energy ";
...
attrib  hinc_uc      length=3     label="Recode - Unemployment compensation ben";
attrib  hucval       length=5     label="Recode - HHLD income - Unemployment co";
attrib  hinc_wc      length=3     label="Recode - Worker's compensation";       
attrib  hwcval       length=5     label="Recode - HHLD income - Worker's compen";
...
attrib  hssival      length=4     label="Recode - HHLD income - Supplemental Se";
attrib  hpaw_yn      length=3     label="Recode - Public Assistance";           
attrib  hpawval      length=4     label="Recode - HHLD income - Public Assistan";
...
attrib  hed_yn       length=3     label="Recode - Educational assistance benefi";
...
attrib  hfinval      length=5     label="Recode - HHLD income - Financial assis";
...
attrib  hothval      length=5     label="All other types of income except HEARN";
...
attrib  hchamp       length=3     label="VA or military health care";           
attrib  hhi_yn       length=3     label="Anyone in HHLD have health insurance"; 
attrib  hhstatus     length=3     label="Recode - Household status";            
attrib  hunder18     length=3     label="Recode - Number of persons in HHLD und";
attrib  htop5pct     length=3     label="Recode - Household income percentiles";
attrib  hpctcut      length=3     label="Recode - HHLD income percentiles - Nat";
...
attrib  hrwicyn      length=3     label="AT ANY TIME LAST YEAR, (WERE YOU/WAS A";
attrib  hfdval       length=4     label="Item 93 - What was the value of all fo";
attrib  tcare_val    length=3     label="Topcode flag for CARE_VAL";            
attrib  care_val     length=4     label="Annual amount paid for child care by h";
...
attrib  fh_seq       length=4     label="Household sequence number Matches H_SE";
...
attrib  fpersons     length=3     label="Number of persons in family Primary fa";
...
attrib  fhusbidx     length=3     label="Index to person record of family husba";
attrib  fspouidx     length=3     label="Index to person record of family spous";
attrib  flastidx     length=3     label="Index to person record of last member ";
attrib  fmlasidx     length=3     label="Index to person record of last member ";
...
attrib  frsppct      length=4     label="Low income cutoff dollar amount of rel";
...
attrib  fucval       length=5     label="Family income - Unemployment compensat";
...
attrib  fpawval      length=4     label="Family income - public assistance inco";
...
attrib  ffinval      length=5     label="Family income - Financial assistance i";
...
attrib  parent       length=3     label="Family members under 18 (excludes refe";
...
attrib  a_payabs     length=3     label="Is ... receiving wages or salary for a";
...
attrib  a_nlflj      length=3     label="When did ... last work for pay at a re";
attrib  a_wantjb     length=3     label="Does ... want a regular job now, eithe";
attrib  prerelg      length=3     label="Earnings eligibility flag";            
attrib  a_uslhrs     length=3     label="How many hrs per week does ...  usuall";
attrib  a_hrlywk     length=3     label="Is ... paid by the hour on this job?"; 
attrib  a_hrspay     length=8     label="How much does ... earn per hour?";     
attrib  a_grswk      length=4     label="How much does ... usually earn per wee";
attrib  a_unmem      length=3     label="On this job, is ... a member of a labo";
attrib  a_uncov      length=3     label="On this job, is ... covered by a union";
attrib  a_enrlw      length=3     label="Last week was ... attending or enrolle";
attrib  a_hscol      length=3     label="";                                     
attrib  a_ftpt       length=3     label="Is ... enrolled in school as a full-ti";
...
attrib  workyn       length=3     label="Item 29a - Did ... work at a job or bu";
attrib  wrk_ck       length=3     label="Item 76 - Interviewer check item worke";
attrib  wtemp        length=3     label="Item 29b - Did ... do any temporary, p";
attrib  nwlook       length=3     label="Item 30 - Even though ... did not work";
attrib  nwlkwk       length=3     label="Item 31 - How may different weeks was ";
attrib  rsnnotw      length=3     label="Item 32 - What was the main reason ...";
attrib  wkswork      length=3     label="Item 33 - During 20.. in how many week";
attrib  wkcheck      length=3     label="Item 34 - Interviewer check item - Num";
attrib  losewks      length=3     label="Item 35 Did ... lose any full weeks of";
attrib  lknone       length=3     label="Item 36 -  You said... worked about (e";
attrib  lkweeks      length=3     label="Item 36 - Weeks was ... looking for wo";
...
attrib  hrcheck      length=3     label="Item 41 - Interviewer check item - Num";
attrib  ptyn         length=3     label="Item 43 - Did ... work less than 35 ho";
...
attrib  wexp         length=3     label="Recode -  Worker/nonworker recode - fu";
attrib  wewkrs       length=3     label="Recode -  Worker/nonworker recode - we";
attrib  welknw       length=3     label="Recode -  Worker/nonworker recode - we";
attrib  weuemp       length=3     label="Recode - Worker/nonworker recode - Par";
attrib  earner       length=3     label="Recode - Earner status";               
attrib  clwk         length=3     label="Recode - Longest job class of worker r";
attrib  weclw        length=3     label="Recode - Longest job class of worker W";
...
attrib  weind        length=3     label="Recode - Industry of longest job by De";
attrib  wemind       length=3     label="Recode - Industry of longest job by ma";
...
attrib  ern_srce     length=3     label="Earnings  recode Source of earnings fr";
...
attrib  wsal_yn      length=3     label="Recode Any wage and salary earnings in";
attrib  wsal_val     length=5     label="Recode - Total wage and salary earning";
attrib  ws_val       length=5     label="Item 49b - Other wage and salary earni";
attrib  seotr        length=3     label="Item 49b - Other work - Own business s";
attrib  semp_yn      length=3     label="Recode - Any own business self- employ";
attrib  semp_val     length=5     label="ERN_YN = 1 or SEOTR = 1 Total own busi";
attrib  se_val       length=4     label="Item 49b - Other work - Own business s";
...
attrib  uc_yn        length=3     label="Item 52a - At any time during 20..  di";
attrib  subuc        length=3     label="Item 52a - At any time during 20..  di";
attrib  strkuc       length=3     label="Item 52a -At any time during 20..  did";
attrib  uc_val       length=4     label="Item 52b - How much did ... receive in";
attrib  wc_yn        length=3     label="Item 53a - During 20.. did ... receive";
attrib  wc_type      length=3     label="Item 53b What was source of these paym";
...
attrib  resnssi1     length=3     label="What were the reasons (you/name) (Was/";
attrib  resnssi2     length=3     label="What were the reasons (you/name) (Was/";
attrib  ssikidyn     length=3     label="Which children under age 18 were Recei";
attrib  paw_yn       length=3     label="Item 59b - Did ... receive public assi";
...
attrib  vet_yn       length=3     label="Item 60b - Did ... receive veterans' p";
...
attrib  pothval      length=5     label="Recode - Total other persons income (A";
...
attrib  champ        length=3     label="Item 74f - Was ... covered by VA or mi";
...
attrib  otyp_1       length=3     label="Covered by TRICARE or military health ";
...
attrib  ihsflg       length=3     label="Recode:  Covered by Indian Health Serv";
...
attrib  ch_hi        length=3     label="A_AGE less than 15 Recode - Child cove";
...
attrib  penincl      length=3     label="Item 76b - Was ... included in that pl";
...
attrib  statetax_bc  length=4     label="State income tax liability, before  cr";
...
LABEL
	...
	hunder15  = "Recode Number of persons in household "
	hh5to18   = "Recode Item 82 - Number of persons in "
	...
	hpublic   = "Item 88 - Is this a public housing pro"
	hlorent   = "Item 89 - Are you paying lower rent be"
	hfoodsp   = "Item 90 - Did anyone in this household"
	hfoodno   = "Item 91 - Number of children covered b"
	hfoodmo   = "Item 92 - Number months covered by foo"
	hengast   = "Item 93 - The gov't has an energy assi"
	hengval   = "Item 94 - Altogether, how much energy "
	...
	hinc_uc   = "Recode - Unemployment compensation ben"
	hucval    = "Recode - HHLD income - Unemployment co"
	hinc_wc   = "Recode - Worker's compensation"        
	hwcval    = "Recode - HHLD income - Worker's compen"
	...
	hssival   = "Recode - HHLD income - Supplemental Se"
	hpaw_yn   = "Recode - Public Assistance"            
	hpawval   = "Recode - HHLD income - Public Assistan"
	...
	hed_yn    = "Recode - Educational assistance benefi"
	...
	hfinval   = "Recode - HHLD income - Financial assis"
	...
	hchamp    = "VA or military health care"            
	hhi_yn    = "Anyone in HHLD have health insurance"  
	hhstatus  = "Recode - Household status"             
	hunder18  = "Recode - Number of persons in HHLD und"
	htop5pct  = "Recode - Household income percentiles" 
	hpctcut   = "Recode - HHLD income percentiles - Nat"
	...
	hrwicyn   = "AT ANY TIME LAST YEAR, (WERE YOU/WAS A"
	hfdval    = "Item 93 - What was the value of all fo"
	tcare_val = "Topcode flag for CARE_VAL"             
	care_val  = "Annual amount paid for child care by h"
	i_careval = "Allocation flag for CARE_VAL"          
	hpres_mort= "Presence of home mortgage (respondent "
	fh_seq    = "Household sequence number Matches H_SE"
	ffpos     = "Unique family identifier"              
	fkind     = "Kind of family"                        
	ftype     = "Family type"                           
	fpersons  = "Number of persons in family Primary fa"
	fheadidx  = "Index to person record of family head" 
	fwifeidx  = "Index to person record of family wife" 
	fhusbidx  = "Index to person record of family husba"
	fspouidx  = "Index to person record of family spous"
	flastidx  = "Index to person record of last member "
	fmlasidx  = "Index to person record of last member "
	...
	frsppct   = "Low income cutoff dollar amount of rel"
	...
	fucval    = "Family income - Unemployment compensat"
	...
	ffinval   = "Family income - Financial assistance i"
	...
	parent    = "Family members under 18 (excludes refe"
	...
	a_payabs  = "Is ... receiving wages or salary for a"
	peioind   = "Industry"                              
	peioocc   = "Occupation"                            
	a_clswkr  = "Class of worker"                       
	a_wkslk   = "Duration of unemployment"              
	a_whenlj  = "When did ... last work?"               
	a_nlflj   = "When did ... last work for pay at a re"
	a_wantjb  = "Does ... want a regular job now, eithe"
	prerelg   = "Earnings eligibility flag"             
	a_uslhrs  = "How many hrs per week does ...  usuall"
	a_hrlywk  = "Is ... paid by the hour on this job?"  
	a_hrspay  = "How much does ... earn per hour?"      
	a_grswk   = "How much does ... usually earn per wee"
	a_unmem   = "On this job, is ... a member of a labo"
	a_uncov   = "On this job, is ... covered by a union"
	a_enrlw   = "Last week was ... attending or enrolle"
	a_ftpt    = "Is ... enrolled in school as a full-ti"
	...
	workyn    = "Item 29a - Did ... work at a job or bu"
	wrk_ck    = "Item 76 - Interviewer check item worke"
	wtemp     = "Item 29b - Did ... do any temporary, p"
	nwlook    = "Item 30 - Even though ... did not work"
	nwlkwk    = "Item 31 - How may different weeks was "
	rsnnotw   = "Item 32 - What was the main reason ..."
	wkswork   = "Item 33 - During 20.. in how many week"
	wkcheck   = "Item 34 - Interviewer check item - Num"
	losewks   = "Item 35 Did ... lose any full weeks of"
	lknone    = "Item 36 -  You said... worked about (e"
	lkweeks   = "Item 36 - Weeks was ... looking for wo"
	...
	hrcheck   = "Item 41 - Interviewer check item - Num"
	ptyn      = "Item 43 - Did ... work less than 35 ho"
	ptweeks   = "Item 44 - How many weeks did ... work "
	ptrsn     = "Item 45 - What was the main reason ..."
	wexp      = "Recode -  Worker/nonworker recode - fu"
	wewkrs    = "Recode -  Worker/nonworker recode - we"
	welknw    = "Recode -  Worker/nonworker recode - we"
	weuemp    = "Recode - Worker/nonworker recode - Par"
	earner    = "Recode - Earner status"                
	clwk      = "Recode - Longest job class of worker r"
	weclw     = "Recode - Longest job class of worker W"
	poccu2    = "Recode - Occupation of longest job by "
	wemocg    = "Recode - Occupation of longest job by "
	weind     = "Recode - Industry of longest job by De"
	wemind    = "Recode - Industry of longest job by ma"
	...
	ern_srce  = "Earnings  recode Source of earnings fr"
	...
	wsal_yn   = "Recode Any wage and salary earnings in"
	wsal_val  = "Recode - Total wage and salary earning"
	ws_val    = "Item 49b - Other wage and salary earni"
	seotr     = "Item 49b - Other work - Own business s"
	semp_yn   = "Recode - Any own business self- employ"
	semp_val  = "ERN_YN = 1 or SEOTR = 1 Total own busi"
	se_val    = "Item 49b - Other work - Own business s"
	...
	uc_yn     = "Item 52a - At any time during 20..  di"
	subuc     = "Item 52a - At any time during 20..  di"
	strkuc    = "Item 52a -At any time during 20..  did"
	uc_val    = "Item 52b - How much did ... receive in"
	wc_yn     = "Item 53a - During 20.. did ... receive"
	wc_type   = "Item 53b What was source of these paym"
	...
	resnssi1  = "What were the reasons (you/name) (Was/"
	resnssi2  = "What were the reasons (you/name) (Was/"
	ssikidyn  = "Which children under age 18 were Recei"
	paw_yn    = "Item 59b - Did ... receive public assi"
	...
	vet_yn    = "Item 60b - Did ... receive veterans' p"
	...
	pothval   = "Recode - Total other persons income (A"
	...
	champ     = "Item 74f - Was ... covered by VA or mi"
	...
	otyp_1    = "Covered by TRICARE or military health "
	...
	ihsflg    = "Recode:  Covered by Indian Health Serv"
	...
	ch_hi     = "A_AGE less than 15 Recode - Child cove"
	...
	statetax_bc= "State income tax liability, before  cr"
...
in a sas data set called fcpmar2016 .
To use the stored formats in a subsequent program,
include something like this:

proc format cntlin=library.fcpmar2016;
PROC freq;
        tables PULAYCK1 ;
...
PROC FORMAT cntlout=library.fcpmar2016;
...
VALUE peioind 	(default=32)
	...
	1490      =  "Textile and fabric finishing and coati"
	...
	1790      =  "Leather tanning and products, except f"
	1870      =  "Pulp, paper, and paperboard mills     "
	1880      =  "Paperboard containers and boxes       "
	1890      =  "Miscellaneous paper and pulp products "
	1990      =  "Printing and related support activitie"
	2070      =  "Petroleum refining                    "
	2090      =  "Miscellaneous petroleum and coal produ"
	2170      =  "Resin, synthetic rubber and fibers, an"
	2180      =  "Agricultural chemical manufacturing   "
	2190      =  "Pharmaceutical and medicine manufactur"
	2270      =  "Paint, coating, and adhesive manufactu"
	...
	2390      =  "Rubber products, except tires, manufac"
	2470      =  "Pottery, ceramics, and related product"
	2480      =  "Structural clay product manufacturing "
	2490      =  "Glass and glass product manufacturing "
	2570      =  "Cement, concrete, lime, and gypsum pro"
	2590      =  "Miscellaneous nonmetallic mineral prod"
	2670      =  "Iron and steel mills and steel product"
	2680      =  "Aluminum production and processing    "
	2690      =  "Nonferrous metal, except aluminum, pro"
	2770      =  "Foundries                             "
	2780      =  "Metal forgings and stampings          "
	2790      =  "Cutlery and hand tool manufacturing   "
	2870      =  "Structural metals, and tank and shippi"
	2880      =  "Machine shops; turned product; screw, "
	2890      =  "Coating, engraving, heat treating and "
	2970      =  "Ordnance                              "
	2980      =  "Miscellaneous fabricated metal product"
	2990      =  "Not specified metal industries        "
	3070      =  "Agricultural implement manufacturing  "
	3080      =  "Construction, mining and oil field mac"
	3090      =  "Commercial and service industry machin"
	3170      =  "Metalworking machinery manufacturing  "
	3180      =  "Engines, turbines, and power transmiss"
	3190      =  "Machinery manufacturing, n.e.c.       "
	3290      =  "Not specified machinery manufacturing "
	3360      =  "Computer and peripheral equipment manu"
	3370      =  "Communications, audio, and video equip"
	3380      =  "Navigational, measuring, electromedica"
	3390      =  "Electronic component and product manuf"
	3470      =  "Household appliance manufacturing     "
	3490      =  "Electrical lighting, equipment, and su"
	3570      =  "Motor vehicles and motor vehicle equip"
	3580      =  "Aircraft and parts manufacturing      "
	3590      =  "Aerospace products and parts manufactu"
	3670      =  "Railroad rolling stock manufacturing  "
	3680      =  "Ship and boat building                "
	3690      =  "Other transportation equipment manufac"
	3770      =  "Sawmills and wood preservation        "
	3780      =  "Veneer, plywood, and engineered wood p"
	3790      =  "Prefabricated wood buildings and mobil"
	3870      =  "Miscellaneous wood products           "
	3890      =  "Furniture and related product manufact"
	3960      =  "Medical equipment and supplies manufac"
	3970      =  "Toys, amusement, and sporting goods ma"
	3980      =  "Miscellaneous manufacturing, n.e.c.   "
	3990      =  "Not specified manufacturing industries"
	4070      =  "** Motor vehicles, parts and supplies,"
	4080      =  "** Furniture and home furnishing, merc"
	4090      =  "** Lumber and other construction mater"
	4170      =  "** Professional and commercial equipme"
	4180      =  "** Metals and minerals, except petrole"
	4190      =  "** Electrical goods, merchant wholesal"
	4260      =  "** Hardware, plumbing and heating equi"
	4270      =  "** Machinery, equipment, and supplies,"
	4280      =  "** Recyclable material, merchant whole"
	4290      =  "** Miscellaneous durable goods, mercha"
	4370      =  "** Paper and paper products, merchant "
	4380      =  "** Drugs, sundries, and chemical and a"
	4390      =  "** Apparel, fabrics, and notions, merc"
	4470      =  "** Groceries and related products, mer"
	4480      =  "** Farm product raw materials, merchan"
	4490      =  "** Petroleum and petroleum products, m"
	4560      =  "** Alcoholic beverages, merchant whole"
	4570      =  "** Farm supplies, merchant wholesalers"
	4580      =  "** Miscellaneous nondurable goods, mer"
	4585      =  "*** Wholesale electronic markets, agen"
	4590      =  "**Not specified wholesale trade       "
	4670      =  "Automobile dealers                    "
	4680      =  "Other motor vehicle dealers           "
	4690      =  "Auto parts, accessories, and tire stor"
	...
	4890      =  "Lawn and garden equipment and supplies"
	4970      =  "Grocery stores                        "
	4980      =  "Specialty food stores                 "
	4990      =  "Beer, wine, and liquor stores         "
	5070      =  "Pharmacies and drug stores            "
	5080      =  "Health and personal care, except drug,"
	5090      =  "Gasoline stations                     "
	5170      =  "Clothing and accessories, except shoe,"
	5180      =  "Shoe stores                           "
	5190      =  "Jewelry, luggage, and leather goods st"
	5270      =  "Sporting goods, camera, and hobby and "
	5280      =  "Sewing, needlework, and piece goods st"
	5290      =  "Music stores                          "
	5370      =  "Book stores and news dealers          "
	5380      =  "****Department stores and discount sto"
	5390      =  "Miscellaneous general merchandise stor"
	...
	6480      =  "**Publishing, except newspapers and so"
	6490      =  "Software publishing                   "
	6570      =  "Motion pictures and video industries  "
	6590      =  "Sound recording industries            "
	6670      =  "Radio and television broadcasting and "
	6675      =  "*** Internet publishing and broadcasti"
	6680      =  "Wired telecommunications carriers     "
	6690      =  "Other telecommunications services     "
	6692      =  "*** Internet service providers        "
	6695      =  "**** Data processing, hosting, and rel"
	6770      =  "Libraries and archives                "
	6780      =  "Other information services            "
	6870      =  "Banking and related activities        "
	6880      =  "Savings institutions, including credit"
	6890      =  "Non-depository credit and related acti"
	6970      =  "Securities, commodities, funds, trusts"
	6990      =  "Insurance carriers and related activit"
	7070      =  "Real estate                           "
	7080      =  "Automotive equipment rental and leasin"
	7170      =  "Video tape and disk rental            "
	7180      =  "Other consumer goods rental           "
	7190      =  "Commercial, industrial, and other inta"
	7270      =  "Legal services                        "
	7280      =  "Accounting, tax preparation, bookkeepi"
	7290      =  "Architectural, engineering, and relate"
	7370      =  "Specialized design services           "
	7380      =  "Computer systems design and related se"
	7390      =  "Management, scientific, and technical "
	7460      =  "Scientific research and development se"
	7470      =  "Advertising and related services      "
	7480      =  "Veterinary services                   "
	7490      =  "Other professional, scientific, and te"
	7570      =  "Management of companies and enterprise"
	7580      =  "Employment services                   "
	7590      =  "Business support services             "
	7670      =  "Travel arrangements and reservation se"
	...
	7790      =  "Waste management and remediation servi"
	7860      =  "Elementary and secondary schools      "
	7870      =  "Colleges and universities, including j"
	7880      =  "Business, technical, and trade schools"
	7890      =  "Other schools, instruction, and educat"
	...
	8290      =  "Residential care facilities, without n"
	8370      =  "Individual and family services        "
	8380      =  "Community food and housing, and emerge"
	8390      =  "Vocational rehabilitation services    "
	8470      =  "Child day care services               "
	8560      =  "Independent artists, performing arts, "
	8570      =  "Museums, art galleries, historical sit"
	8580      =  "Bowling centers                       "
	8590      =  "Other amusement, gambling, and recreat"
	8660      =  "Traveler accommodation                "
	8670      =  "Recreational vehicle parks and camps, "
	8680      =  "Restaurants and other food services   "
	8690      =  "Drinking places, alcoholic beverages  "
	8770      =  "Automotive repair and maintenance     "
	8780      =  "Car washes                            "
	8790      =  "Electronic and precision equipment rep"
	8870      =  "Commercial and industrial machinery an"
	8880      =  "Personal and household goods repair an"
	8890      =  "Footwear and leather goods repair     "
	8970      =  "Barber shops                          "
	8980      =  "Beauty salons                         "
	8990      =  "Nail salons and other personal care se"
	9070      =  "Dry cleaning and laundry services     "
	9080      =  "Funeral homes, cemeteries, and cremato"
	...
	9370      =  "Executive offices and legislative bodi"
	9380      =  "Public finance activities             "
	9390      =  "Other general government and support  "
	9470      =  "Justice, public order, and safety acti"
	9480      =  "Administration of human resource progr"
	9490      =  "Administration of environmental qualit"
	9570      =  "Administration of economic programs an"
	9590      =  "National security and international af"
	9890      =  "Armed Forces"                  
;
VALUE peioocc 	(default=32)
	...
	0110      =  "Computer and information systems manag"
	...
	0160      =  "Transportation, storage, and distribut"
	0205      =  "Farmers, ranchers, and other agricultu"
	...
	0410      =  "Property, real estate, and community a"
	0420      =  "Social and community service managers"
	0425      =  "Emergency management directors"
	0430      =  "Managers, all other"           
	0500      =  "Agents and business managers of artist"
	0510      =  "Purchasing agents and buyers, farm pro"
	0520      =  "Wholesale and retail buyers, except fa"
	0530      =  "Purchasing agents, except wholesale, r"
	0540      =  "Claims adjusters, appraisers, examiner"
	0565      =  "Compliance officers"           
	0600      =  "Cost estimators"               
	0630      =  "Human resource workers"        
	0640      =  "Compensation, benefits, and job analys"
	0650      =  "Training and development specialists"
	0700      =  "Logisticians"                  
	0710      =  "Management analysts"           
	0725      =  "Meeting, convention, and event planner"
	0726      =  "Fundraisers"                   
	0735      =  "Market research analysts and marketing"
	0740      =  "Business operations specialists, all o"
	0800      =  "Accountants and auditors"      
	0810      =  "Appraisers and assessors of real estat"
	...
	0930      =  "Tax examiners, collectors, and revenue"
	0940      =  "Tax prepares"                  
	0950      =  "Financial specialists, all other"
	1005      =  "Computer and information research scie"
	1006      =  "Computer systems analysts"     
	1007      =  "Information security analysts" 
	1010      =  "Computer programmers"          
	1020      =  "Software developers, applications and "
	1030      =  "Web developers"                
	1050      =  "Computer support specialists"  
	1060      =  "Database administrators"       
	1105      =  "Network and computer systems administr"
	...
	1230      =  "Statisticians"                 
	1240      =  "Miscellaneous mathematical science occ"
	1300      =  "Architects, except naval 17-1010"
	1310      =  "Surveyors, cartographers, and photogra"
	...
	1740      =  "Environmental scientists and geoscient"
	...
	1860      =  "Miscellaneous social scientists and re"
	1900      =  "Agricultural and food science technici"
	...
	1965      =  "Miscellaneous life, physical, and soci"
	2000      =  "Counselors"                    
	2010      =  "Social workers"                
	2015      =  "Probation officers and correctional tr"
	2016      =  "Social and human service assistants"
	2025      =  "Miscellaneous community and social ser"
	2040      =  "Clergy"                        
	2050      =  "Directors, religious activities and ed"
	2060      =  "Religious workers, all other"  
	2100      =  "Lawyers, Judges, magistrates, and othe"
	...
	2400      =  "Archivists, curators, and museum techn"
	2430      =  "Librarians"                    
	2440      =  "Library technicians"           
	2540      =  "Teacher assistants"            
	2550      =  "Other education, training, and library"
	2600      =  "Artists and related workers"   
	2630      =  "Designers"                     
	2700      =  "Actors"                        
	2710      =  "Producers and directors"       
	2720      =  "Athletes, coaches, umpires, and relate"
	2740      =  "Dancers and choreographers"    
	2750      =  "Musicians, singers, and related worker"
	2760      =  "Entertainers and performers, sports an"
	2800      =  "Announcers"                    
	2810      =  "News analysts, reporters and correspon"
	...
	2900      =  "Broadcast and sound engineering techni"
	2910      =  "Photographers"                 
	2920      =  "Television, video, and motion picture "
	2960      =  "Media and communication equipment work"
	3000      =  "Chiropractors"                 
	3010      =  "Dentists"                      
	...
	3260      =  "Health diagnosing and treating practit"
	3300      =  "Clinical laboratory technologists and "
	3310      =  "Dental hygienists"             
	3320      =  "Diagnostic related technologists and t"
	3400      =  "Emergency medical technicians and para"
	3420      =  "Health diagnosing and treating practit"
	3500      =  "Licensed practical and licensed vocati"
	3510      =  "Medical records and health information"
	3520      =  "Opticians, dispensing"         
	3535      =  "Miscellaneous health technologists and"
	3540      =  "Other healthcare practitioners and tec"
	3600      =  "Nursing, psychiatric, and home health "
	3610      =  "Occupational therapist assistants and "
	3620      =  "Physical therapist assistants and aide"
	3630      =  "Massage therapists"            
	3640      =  "Dental assistants"             
	3645      =  "Medical assistants"            
	3646      =  "Medical transcriptionists"     
	3647      =  "Pharmacy aides"                
	3648      =  "Veterinary assistants and laboratory a"
	3649      =  "Phlebotomists"                 
	3655      =  "Miscellaneous healthcare support occup"
	3700      =  "First-line supervisors/managers of cor"
	3710      =  "First-line supervisors/managers of pol"
	3720      =  "First-line supervisors/managers of fir"
	3730      =  "Supervisors, protective service worker"
	3740      =  "Fire fighters"                 
	3750      =  "Fire inspectors"               
	3800      =  "Bailiffs, correctional officers, and j"
	...
	3920      =  "Security guards and gaming surveillanc"
	3940      =  "Crossing guards"               
	3945      =  "Transportation security screeners"
	3955      =  "Lifeguards and other recreational and "
	4000      =  "Chefs and head cooks"          
	4010      =  "First-line supervisors/managers of foo"
	4020      =  "Cooks"                         
	4030      =  "Food preparation workers"      
	4040      =  "Bartenders"                    
	4050      =  "Combined food preparation and serving "
	4060      =  "Counter attendants, cafeteria, food co"
	4110      =  "Waiters and waitresses"        
	4120      =  "Food servers, nonrestaurant"   
	4130      =  "Dining room and cafeteria attendants a"
	4140      =  "Dishwashers"                   
	4150      =  "Hosts and hostesses, restaurant, loung"
	4160      =  "Food preparation and serving related w"
	4200      =  "First-line supervisors/managers of hou"
	4210      =  "First-line supervisors/managers of lan"
	...
	4300      =  "First-line supervisors/managers of gam"
	4320      =  "First-line supervisors/managers of per"
	4340      =  "Animal trainers"               
	4350      =  "Nonfarm animal caretakers"     
	4400      =  "Gaming services workers"       
	4410      =  "Motion picture projectionists" 
	4420      =  "Ushers, lobby attendants, and ticket t"
	4430      =  "Miscellaneous entertainment attendants"
	4460      =  "Embalmers and funeral attendants"
	4465      =  "Morticians, undertakers, and funeral d"
	4500      =  "Barbers"                       
	4510      =  "Hairdressers, hairstylists, and cosmet"
	4520      =  "Miscellaneous personal appearance work"
	4530      =  "Baggage porters, bellhops, and concier"
	...
	4650      =  "Personal care and service workers, all"
	4700      =  "First-line supervisors/managers of ret"
	4710      =  "First-line supervisors/managers of non"
	4720      =  "Cashiers"                      
	...
	4820      =  "Securities, commodities, and financial"
	4830      =  "Travel agents"                 
	4840      =  "Sales representatives, services, all o"
	4850      =  "Sales representatives, wholesale and m"
	4900      =  "Models, demonstrators, and product pro"
	4920      =  "Real estate brokers and sales agents"
	4930      =  "Sales engineers"               
	4940      =  "Telemarketers"                 
	4950      =  "Door-to-door sales workers, news and s"
	4965      =  "Sales and related workers, all other"
	5000      =  "First-line supervisors/managers of off"
	5010      =  "Switchboard operators, including answe"
	5020      =  "Telephone operators"           
	5030      =  "Communications equipment operators, al"
	5100      =  "Bill and account collectors"   
	5110      =  "Billing and posting clerks and machine"
	5120      =  "Bookkeeping, accounting, and auditing "
	...
	5230      =  "Credit authorizers, checkers, and cler"
	5240      =  "Customer service representatives"
	5250      =  "Eligibility interviewers, government p"
	5260      =  "File Clerks"                   
	5300      =  "Hotel, motel, and resort desk clerks"
	5310      =  "Interviewers, except eligibility and l"
	5320      =  "Library assistants, clerical"  
	5330      =  "Loan interviewers and clerks"  
	5340      =  "New accounts clerks"           
	5350      =  "Order clerks"                  
	5360      =  "Human resources assistants, except pay"
	5400      =  "Receptionists and information clerks"
	5410      =  "Reservation and transportation ticket "
	5420      =  "Information and record clerks, all oth"
	...
	5560      =  "Postal service mail sorters, processor"
	5600      =  "Production, planning, and expediting c"
	5610      =  "Shipping, receiving, and traffic clerk"
	5620      =  "Stock clerks and order fillers"
	5630      =  "Weighers, measurers, checkers, and sam"
	5700      =  "Secretaries and administrative assista"
	5800      =  "Computer operators"            
	5810      =  "Data entry keyers"             
	5820      =  "Word processors and typists"   
	5830      =  "Desktop publishers"            
	5840      =  "Insurance claims and policy processing"
	5850      =  "Mail clerks and mail machine operators"
	5860      =  "Office clerks, general"        
	5900      =  "Office machine operators, except compu"
	5910      =  "Proofreaders and copy markers" 
	5920      =  "Statistical assistants"        
	5940      =  "Office and administrative support work"
	6005      =  "First-line supervisors of farming, fis"
	6010      =  "Agricultural inspectors"       
	6020      =  "Animal breeders"               
	6040      =  "Graders and sorters, agricultural prod"
	...
	6200      =  "First-line supervisors/managers of con"
	6210      =  "Boilermakers"                  
	6220      =  "Brickmasons, blockmasons, and stonemas"
	6230      =  "Carpenters"                    
	6240      =  "Carpet, floor, and tile installers and"
	6250      =  "Cement masons, concrete finishers, and"
	6260      =  "Construction laborers"         
	6300      =  "Paving, surfacing, and tamping equipme"
	6310      =  "Pile-driver operators"         
	6320      =  "Operating engineers and other construc"
	6330      =  "Drywall installers, ceiling tile insta"
	6355      =  "Electricians"                  
	6360      =  "Glaziers"                      
	...
	6740      =  "Rail-track laying and maintenance equi"
	6750      =  "Septic tank servicers and sewer pipe c"
	6765      =  "Miscellaneous construction and related"
	6800      =  "Derrick, rotary drill, and service uni"
	6820      =  "Earth drillers, except oil and gas"
	6830      =  "Explosives workers, ordnance handling "
	...
	7000      =  "First-line supervisors/managers of mec"
	7010      =  "Computer, automated teller, and office"
	7020      =  "Radio and telecommunications equipment"
	7030      =  "Avionics technicians"          
	7040      =  "Electric motor, power tool, and relate"
	7050      =  "Electrical and electronics installers "
	7100      =  "Electrical and electronics repairers, "
	7110      =  "Electronic equipment installers and re"
	7120      =  "Electronic home entertainment equipmen"
	7130      =  "Security and fire alarm systems instal"
	7140      =  "Aircraft mechanics and service technic"
	7150      =  "Automotive body and related repairers"
	7160      =  "Automotive glass installers and repair"
	7200      =  "Automotive service technicians and mec"
	7210      =  "Bus and truck mechanics and diesel eng"
	7220      =  "Heavy vehicle and mobile equipment ser"
	7240      =  "Small engine mechanics"        
	7260      =  "Miscellaneous vehicle and mobile equip"
	7300      =  "Control and valve installers and repai"
	7315      =  "Heating, air conditioning, and refrige"
	7320      =  "Home appliance repairers"      
	7330      =  "Industrial and refractory machinery me"
	7340      =  "Maintenance and repair workers, genera"
	7350      =  "Maintenance workers, machinery"
	7360      =  "Millwrights"                   
	7410      =  "Electrical power-line installers and r"
	7420      =  "Telecommunications line installers and"
	7430      =  "Precision instrument and equipment rep"
	7440      =  "Wind turbine service technicians"
	7510      =  "Coin, vending, and amusement machine s"
	7520      =  "Commercial divers"             
	7540      =  "Locksmiths and safe repairers" 
	7550      =  "Manufactured building and mobile home "
	7560      =  "Riggers"                       
	7600      =  "Signal and track switch repairers"
	7610      =  "Helpers--installation, maintenance, an"
	7630      =  "Other installation, maintenance, and r"
	7700      =  "First-line supervisors/managers of pro"
	7710      =  "Aircraft structure, surfaces, rigging,"
	7720      =  "Electrical, electronics, and electrome"
	7730      =  "Engine and other machine assemblers"
	7740      =  "Structural metal fabricators and fitte"
	7750      =  "Miscellaneous assemblers and fabricato"
	7800      =  "Bakers"                        
	7810      =  "Butchers and other meat, poultry, and "
	7830      =  "Food and tobacco roasting, baking, and"
	7840      =  "Food batchmakers"              
	7850      =  "Food cooking machine operators and ten"
	7855      =  "Food processing workers, all other"
	7900      =  "Computer control programmers and opera"
	7920      =  "Extruding and drawing machine setters,"
	7930      =  "Forging machine setters, operators, an"
	7940      =  "Rolling machine setters, operators, an"
	7950      =  "Cutting, punching, and press machine s"
	7960      =  "Drilling and boring machine tool sette"
	8000      =  "Grinding, lapping, polishing, and buff"
	8010      =  "Lathe and turning machine tool setters"
	8020      =  "Milling and planing machine setters, o"
	8030      =  "Machinists"                    
	8040      =  "Metal furnace and kiln operators and t"
	8060      =  "Model makers and patternmakers, metal "
	8100      =  "Molders and molding machine setters, o"
	8120      =  "Multiple machine tool setters, operato"
	8130      =  "Tool and die makers"           
	8140      =  "Welding, soldering, and brazing worker"
	8150      =  "Heat treating equipment setters, opera"
	8160      =  "Lay-out workers, metal and plastic"
	8200      =  "Plating and coating machine setters, o"
	8210      =  "Tool grinders, filers, and sharpeners"
	8220      =  "Metalworkers and plastic workers, all "
	...
	8310      =  "Pressers, textile, garment, and relate"
	...
	8360      =  "Textile bleaching and dyeing machine o"
	8400      =  "Textile cutting machine setters, opera"
	8410      =  "Textile knitting and weaving machine s"
	8420      =  "Textile winding, twisting, and drawing"
	8430      =  "Extruding and forming machine setters,"
	8440      =  "Fabric and apparel patternmakers"
	8450      =  "Upholsterers"                  
	8460      =  "Textile, apparel, and furnishings work"
	8500      =  "Cabinetmakers and bench carpenters"
	8510      =  "Furniture finishers"           
	8520      =  "Model makers and patternmakers, wood"
	8530      =  "Sawing machine setters, operators, and"
	8540      =  "Woodworking machine setters, operators"
	8550      =  "Woodworkers, all other"        
	8600      =  "Power plant operators, distributors, a"
	8610      =  "Stationary engineers and boiler operat"
	8620      =  "Water and liquid waste treatment plant"
	8630      =  "Miscellaneous plant and system operato"
	8640      =  "Chemical processing machine setters, o"
	8650      =  "Crushing, grinding, polishing, mixing,"
	8710      =  "Cutting workers"               
	8720      =  "Extruding, forming, pressing, and comp"
	8730      =  "Furnace, kiln, oven, drier, and kettle"
	8740      =  "Inspectors, testers, sorters, samplers"
	8750      =  "Jewelers and precious stone and metal "
	8760      =  "Medical, dental, and ophthalmic labora"
	8800      =  "Packaging and filling machine operator"
	8810      =  "Painting workers"              
	8830      =  "Photographic process workers and proce"
	8840      =  "Semiconductor processors"      
	8850      =  "Cementing and gluing machine operators"
	8860      =  "Cleaning, washing, and metal pickling "
	8900      =  "Cooling and freezing equipment operato"
	8910      =  "Etchers and engravers"         
	8920      =  "Molders, shapers, and casters, except "
	8930      =  "Paper goods machine setters, operators"
	8940      =  "Tire builders"                 
	8950      =  "Helpers--production workers"   
	8965      =  "Production workers, all other" 
	9000      =  "Supervisors, transportation and materi"
	9030      =  "Aircraft pilots and flight engineers"
	9040      =  "Air traffic controllers and airfield o"
	9110      =  "Ambulance drivers and attendants, exce"
	9120      =  "Bus drivers"                   
	...
	9230      =  "Railroad brake, signal, and switch ope"
	9240      =  "Railroad conductors and yardmasters"
	9260      =  "Subway, streetcar, and other rail tran"
...
VALUE mig_reg 	(default=32)
	0         =  "Not in universe under 1 year old/nonmo"
	1         =  "Northeast"                     
	2         =  "Midwest"                       
	3         =  "South"                         
	4         =  "West"                          
...
proc print data=library.cpsmar2016 (obs=6);
...
FORMAT
	...
	tchsp_val  tchsp_val.
;
proc contents data=library.cpsmar2016;
run;
/*
