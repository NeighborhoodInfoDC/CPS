/**************************************************************************
 ...
 Description:  Read CPS 2004 March Supplement from raw data into SAS
 data set.

 Based on Cpsmar04.sas written by Jean Roth and downloaded from the
...
%let year = 2004;
%let outlib = cps;
%let inpath = D:\DCData\Libraries\CPS\Raw\cpsmar04.zip;
%let infile = cpsmar04.dat;
%let out = &outlib..Cps_sup_&year._&month;

/*------------------------------------------------------------------------------------*/
/*by Jean Roth	Tue Oct  5 16:16:36 EDT 2004
...
missing A;
infile datafile lrecl = 1300 stopover ;
* To read in uncompressed file, uncomment INFILE & comment filename & infile lines;
*INFILE '/home/data/cps/cpsmar04.raw' LRECL=1300 missover;
...
LABEL
	...
	PTYN      = "Item 42 - Did ... work less than"      
...
/***PT***
proc print data=library.cpsmar04 (obs=6);
*proc contents data=library.cpsmar04;
*****/
