...
PROC FORMAT cntlout=library.fcpmar04;

/*
The PROC FORMAT statement will store the formats in a sas data set called fcpmar04
To use the stored formats in a subsequent program, include something like this:

proc format cntlin=library.fcpmar04;
PROC freq;
        tables HUNDER15 ;
...
filename raw pipe "unzip -p /homes/data/cps/cpsmar04.zip  ";

data library.cpsmar04;
