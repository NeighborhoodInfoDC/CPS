...
FILENAME datafile pipe "unzip -p /homes/data/cps/cpsmar05.zip ";

*  The following line should contain the name of the SAS dataset ;

%let dataset = cpsmar05 ;
...
in a sas data set called fcpmar05 .
To use the stored formats in a subsequent program,
include something like this:

proc format cntlin=library.fcpmar05;
PROC freq;
        tables PULAYCK1 ;
...
PROC FORMAT cntlout=library.fcpmar05;
...
VALUE fedtax_ac	(default=32)
	0         =  "None"                          
;
VALUE statetax_b	(default=32)
	0         =  "None"                          
;
VALUE statetax_a	(default=32)
	0         =  "None"                          
;
...
options nolabel ;
proc means data=library.cpsmar05 ;
