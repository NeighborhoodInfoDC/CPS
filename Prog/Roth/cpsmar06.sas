...
FILENAME datafile pipe "unzip -p /homes/data/cps/cpsmar06.zip ";

*  The following line should contain the name of the SAS dataset ;

%let dataset = cpsmar06 ;
...
in a sas data set called fcpmar06 .
To use the stored formats in a subsequent program,
include something like this:

proc format cntlin=library.fcpmar06;
PROC freq;
        tables PULAYCK1 ;
...
PROC FORMAT cntlout=library.fcpmar06;
...
;
VALUE purkatel	(default=32)
	-1        =  "NIU"                           
	1         =  "Person eligible for Katrina"   
	2         =  "Person not eligible for"       
;

proc print data=library.cpsmar06 (obs=6);
...
FORMAT
	...
	purkatel   purkatel. 
;
proc contents data=library.cpsmar06;
/*
