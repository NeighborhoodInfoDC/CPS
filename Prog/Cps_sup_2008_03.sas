...
/*------------------------------------------------
  by Jean Roth	Tue Sep  2 12:43:11 EDT 2008
...
/* FILENAME datafile pipe "unzip -p /homes/data/cps/cpsmar08.zip "; */

*  The following line should contain the name of the SAS dataset ;

/* %let dataset = cpsmar08 ; */
...
in a sas data set called fcpmar08 .
To use the stored formats in a subsequent program,
include something like this:

proc format cntlin=library.fcpmar08;
PROC freq;
        tables PULAYCK1 ;
...
/* proc print data=library.cpsmar08 (obs=6); */
...
/* proc contents data=library.cpsmar08; */
/*
