/**************************************************************************
 ...
 Description:  Read CPS 2006 March Supplement from raw data into SAS.
...
/***PT***FILENAME datafile pipe "unzip -p /homes/data/cps/cpsmar06.zip ";*****/

*  The following line should contain the name of the SAS dataset ;

/***PT***%let dataset = cpsmar06 ;*****/
...
attrib  hurhhscrn    length=3     label="Is there anyone living here who had   ";
attrib  purkat1      length=3     label="Recode - Did ... have to evacuate, eve";
attrib  purkat2      length=3     label="In August, prior to the hurricane";    
attrib  purkatel     length=3     label="Katrina eligibility flag";             
...
LABEL
	...
	hurhhscrn = "Is there anyone living here who had   "
	purkat1   = "Recode - Did ... have to evacuate, eve"
	purkat2   = "In August, prior to the hurricane"     
	purkatel  = "Katrina eligibility flag"              
; 

/***PT***DELETED PROC FORMAT*****/

/***PT***proc print data=library.cpsmar06 (obs=6);*****/
...
/***PT***proc contents data=library.cpsmar06;*****/
