/**************************************************************************
 ...
 Description:  Read CPS March 2018 data.
...
libname library "/homes/data/cps" inencoding=any ;

*  The following line should contain
   the complete path and name of the raw data file.
   On a PC, use backslashes in paths as in C:\	 ;

FILENAME datafile pipe "unzip -p /homes/data/cps/cpsmar2018.zip ";

*  The following line should contain the name of the SAS dataset ;

%let dataset = cpsmar2018 ;
...
attrib  hhpos        length=3     label="Trailer portion of unique household ID";
attrib  hunits       length=3     label="Item 78 - How many units in the struct";
attrib  hefaminc     length=3     label="Family income";                        
attrib  h_respnm     length=3     label="Line number of household respondent";  
...
attrib  gtcsa        length=3     label="Consolidated Statistical Area (CSA) FI";
...
attrib  hhotlun      length=3     label="Item 80 - During 20.. how many of the ";
attrib  hhotno       length=3     label="Item 80 - Number of children in househ";
attrib  hflunch      length=3     label="Item 83 - During 20.. how many of the ";
attrib  hflunno      length=3     label="Item 83 - Number receiving free or red";
attrib  hpublic      length=3     label="Item 85 - Is this public housing, that";
attrib  hlorent      length=3     label="Item 86 - Are you paying lower rent be";
attrib  hfoodsp      length=3     label="Item 87 - Did anyone in this household";
attrib  hfoodno      length=3     label="Item 88 - Which of the people now livi";
attrib  hfoodmo      length=3     label="Item 902 - How many months was food as";
...
attrib  hrnumwic     length=3     label="NUMBER OF PEOPLE IN THE HOUSEHOLD RECE";
attrib  hrwicyn      length=3     label="AT ANY TIME DURING 20.., , (WERE YOU/W";
attrib  hfdval       length=4     label="Item 90 - What was the (monthly) value";
...
attrib  pecert1      length=3     label="Do you have a currently active profess";
attrib  pecert2      length=3     label="Were any of your certifications or lic";
attrib  pecert3      length=3     label="Is your certification required for you";
...
attrib  nwlkwk       length=3     label="Item 31 - How many different weeks";   
...
attrib  ptyn         length=3     label="Item 43 - During 20.., were there one ";
attrib  ptweeks      length=3     label="Item 44 - In the weeks that ... worked";
...
attrib  noemp        length=3     label="Item 4788 - Counting all locations whe";
...
attrib  ws_val       length=5     label="Item 49b1 - Other wage and salary";    
attrib  seotr        length=3     label="Item 49b2 - Other work - Own business";
attrib  semp_yn      length=3     label="Recode - Any own business self-";      
attrib  semp_val     length=5     label="ERN_YN = 1 or SEOTR = 1";              
attrib  se_val       length=4     label="Item 49b2 - Other work - Own business";
attrib  frmotr       length=3     label="Item 49b4- Farm self-employment";      
...
attrib  frm_val      length=4     label="Item 49b4 - Farm self-employment earni";
attrib  uc_yn        length=3     label="Item 51a1 - At any time during 20..";  
attrib  subuc        length=3     label="Item 51a2 - At any time during 20..";  
attrib  strkuc       length=3     label="Item 51a3 -At any time during 20..";   
attrib  uc_val       length=4     label="Item 51b - How much did ... receive in";
attrib  wc_yn        length=3     label="Item 52a - During 20.. did ... receive";
attrib  wc_type      length=3     label="Item 52b What was source of these paym";
attrib  wc_val       length=4     label="Item 52c - How much compensation did"; 
attrib  ss_yn        length=3     label="Item 56b - Did ... receive social secu";
attrib  ss_val       length=4     label="Item 56d - How much did ... receive";  
...
attrib  paw_yn       length=3     label="Item 59b - Did ... receive any CASH as";
attrib  paw_typ      length=3     label="Item 59c - From what type of program d";
attrib  paw_mon      length=3     label="Item 59d - In how many months of 20.. ";
attrib  paw_val      length=4     label="Item 59e - During 20.., how much CASH ";
...
attrib  vet_val      length=4     label="Item 60v - How much did ... receive be";
attrib  sur_yn       length=3     label="Item 58b - (Other than social security";
attrib  sur_sc1      length=3     label="Item 58c - What was the source of this";
attrib  sur_sc2      length=3     label="Item 58d - Any other survivor benefits";
attrib  sur_val1     length=4     label="Item 58e1 - how much did ... receive f";
attrib  sur_val2     length=4     label="Item 58e2 - How much did ... receive f";
attrib  srvs_val     length=4     label="Recode total amount of survivor's inco";
attrib  dis_hp       length=3     label="Item 59b -  Does ... have a health pro";
attrib  dis_cs       length=3     label="Item 60b - Did ... retire or leave a j";
attrib  dis_yn       length=3     label="Item 61b -   Did ... receive any disab";
attrib  dis_sc1      length=3     label="Item 61c - What was the source of this";
attrib  dis_sc2      length=3     label="Item 61c - Any other disability income";
attrib  dis_val1     length=4     label="Item 61e1 - How much did ... receive f";
attrib  dis_val2     length=4     label="Item 61e2 - How much did ... receive f";
attrib  dsab_val     length=4     label="Recode total amount of disability inco";
attrib  ret_yn       length=3     label="Item 62b/96b/97b - Other than social s";
attrib  ret_sc1      length=3     label="Item 62c,d/97c,d - What was the source";
attrib  ret_sc2      length=3     label="Item 62c,d/97c,d - Any other retiremen";
attrib  ret_val1     length=4     label="Item 62e1/ANNNEW2/DISTNEW2 - How much ";
attrib  ret_val2     length=4     label="Item 62e2/DISTNEW7 - How much did ... ";
attrib  rtm_val      length=4     label="Recode total amount of retirement inco";
attrib  int_yn       length=3     label="Item 99ArA-E,G - At any time during 20";
attrib  int_val      length=4     label="Item NONRETIRENEW/RETIRENEW - How much";
attrib  div_yn       length=3     label="Item 99ArF - At anytime during 20..,"; 
attrib  div_val      length=4     label="Item NONRETIRENEW - How much did ..."; 
attrib  rnt_yn       length=3     label="Item 65b - Did ... own any land,";     
attrib  rnt_val      length=4     label="Item 65c - How much did ... receive in";
attrib  ed_yn        length=3     label="Item 66c - Did ... receive educational";
...
attrib  ed_val       length=4     label="Item 66h - Total amount of educational";
...
attrib  fin_yn       length=3     label="Item 72b - Did ... receive any regular";
attrib  fin_val      length=4     label="Item 72c - How much did ... receive in";
attrib  oi_off       length=3     label="Item 73";                              
attrib  oi_yn        length=3     label="Item 73a - Did ... receive cash income";
attrib  oi_val       length=4     label="Item 731 - How much did ... receive in";
...
attrib  penplan      length=3     label="Item 74a - Other than social security ";
attrib  penincl      length=3     label="Item 74b - Was ... included in that pl";
...
attrib  fica         length=4     label="Social security retirement payroll ded";
...
attrib  pxcert1      length=3     label="Allocation flag for PECERT1";          
attrib  pxcert2      length=3     label="Allocation flag for PECERT2";          
attrib  pxcert3      length=3     label="Allocation flag for PECERT3";          
...
LABEL
	...
	hhpos     = "Trailer portion of unique household ID"
	...
	gtcsa     = "Consolidated Statistical Area (CSA) FI"
	hunder15  = "Recode: Number of persons in household"
	hh5to18   = "Recode: Item 82 - Number of persons in"
	hhotlun   = "Item 80 - During 20.. how many of the "
	hhotno    = "Item 80 - Number of children in househ"
	hflunch   = "Item 83 - During 20.. how many of the "
	hflunno   = "Item 83 - Number receiving free or red"
	hpublic   = "Item 85 - Is this public housing, that"
	hlorent   = "Item 86 - Are you paying lower rent be"
	hfoodsp   = "Item 87 - Did anyone in this household"
	hfoodno   = "Item 88 - Which of the people now livi"
	hfoodmo   = "Item 902 - How many months was food as"
	...
	hrnumwic  = "NUMBER OF PEOPLE IN THE HOUSEHOLD RECE"
	hrwicyn   = "AT ANY TIME DURING 20.., , (WERE YOU/W"
	hfdval    = "Item 90 - What was the (monthly) value"
	...
	pecert1   = "Do you have a currently active profess"
	pecert2   = "Were any of your certifications or lic"
	pecert3   = "Is your certification required for you"
	...
	nwlkwk    = "Item 31 - How many different weeks"    
	...
	ptyn      = "Item 43 - During 20.., were there one "
	ptweeks   = "Item 44 - In the weeks that ... worked"
	...
	noemp     = "Item 4788 - Counting all locations whe"
	...
	ws_val    = "Item 49b1 - Other wage and salary"     
	seotr     = "Item 49b2 - Other work - Own business" 
	semp_yn   = "Recode - Any own business self-"       
	semp_val  = "ERN_YN = 1 or SEOTR = 1"               
	se_val    = "Item 49b2 - Other work - Own business" 
	frmotr    = "Item 49b4- Farm self-employment"       
	frse_yn   = "Any own farm self-employment in ERN_YN"
	frse_val  = "Recode - Total amount of farm self-"   
	frm_val   = "Item 49b4 - Farm self-employment earni"
	uc_yn     = "Item 51a1 - At any time during 20.."   
	subuc     = "Item 51a2 - At any time during 20.."   
	strkuc    = "Item 51a3 -At any time during 20.."    
	uc_val    = "Item 51b - How much did ... receive in"
	wc_yn     = "Item 52a - During 20.. did ... receive"
	wc_type   = "Item 52b What was source of these paym"
	wc_val    = "Item 52c - How much compensation did"  
	ss_yn     = "Item 56b - Did ... receive social secu"
	ss_val    = "Item 56d - How much did ... receive"   
	...
	paw_yn    = "Item 59b - Did ... receive any CASH as"
	paw_typ   = "Item 59c - From what type of program d"
	paw_mon   = "Item 59d - In how many months of 20.. "
	paw_val   = "Item 59e - During 20.., how much CASH "
	...
	vet_val   = "Item 60v - How much did ... receive be"
	sur_yn    = "Item 58b - (Other than social security"
	sur_sc1   = "Item 58c - What was the source of this"
	sur_sc2   = "Item 58d - Any other survivor benefits"
	sur_val1  = "Item 58e1 - how much did ... receive f"
	sur_val2  = "Item 58e2 - How much did ... receive f"
	srvs_val  = "Recode total amount of survivor's inco"
	dis_hp    = "Item 59b -  Does ... have a health pro"
	dis_cs    = "Item 60b - Did ... retire or leave a j"
	dis_yn    = "Item 61b -   Did ... receive any disab"
	dis_sc1   = "Item 61c - What was the source of this"
	dis_sc2   = "Item 61c - Any other disability income"
	dis_val1  = "Item 61e1 - How much did ... receive f"
	dis_val2  = "Item 61e2 - How much did ... receive f"
	dsab_val  = "Recode total amount of disability inco"
	ret_yn    = "Item 62b/96b/97b - Other than social s"
	ret_sc1   = "Item 62c,d/97c,d - What was the source"
	ret_sc2   = "Item 62c,d/97c,d - Any other retiremen"
	ret_val1  = "Item 62e1/ANNNEW2/DISTNEW2 - How much "
	ret_val2  = "Item 62e2/DISTNEW7 - How much did ... "
	rtm_val   = "Recode total amount of retirement inco"
	int_yn    = "Item 99ArA-E,G - At any time during 20"
	int_val   = "Item NONRETIRENEW/RETIRENEW - How much"
	div_yn    = "Item 99ArF - At anytime during 20..,"  
	div_val   = "Item NONRETIRENEW - How much did ..."  
	rnt_yn    = "Item 65b - Did ... own any land,"      
	rnt_val   = "Item 65c - How much did ... receive in"
	ed_yn     = "Item 66c - Did ... receive educational"
	oed_typ1  = "Item Q66d(2,3,&  4) - Source of"       
	oed_typ2  = "Item Q66d(5) - Source of educational"  
	oed_typ3  = "Item Q66d(6)- Source of educational"   
	ed_val    = "Item 66h - Total amount of educational"
	csp_yn    = "Item 70b - Did ... receive child suppo"
	csp_val   = "Item 70c - How much did ... receive in"
	fin_yn    = "Item 72b - Did ... receive any regular"
	fin_val   = "Item 72c - How much did ... receive in"
	oi_off    = "Item 73"                               
	oi_yn     = "Item 73a - Did ... receive cash income"
	oi_val    = "Item 731 - How much did ... receive in"
	...
	penplan   = "Item 74a - Other than social security "
	penincl   = "Item 74b - Was ... included in that pl"
	...
	fica      = "Social security retirement payroll ded"
...
in a sas data set called fcpmar2018 .
To use the stored formats in a subsequent program,
include something like this:

proc format cntlin=library.fcpmar2018;
PROC freq;
        tables PULAYCK1 ;
...
PROC FORMAT cntlout=library.fcpmar2018;
...
proc print data=library.cpsmar2018 (obs=6);
...
FORMAT
	...
	tchsp_val  tchsp_val.
;
proc contents data=library.cpsmar2018;
run;
/*
