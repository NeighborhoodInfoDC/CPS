/**************************************************************************
 ...
 Description:  Read CPS 2005 March Supplement from raw data into SAS
 data set.

 Based on Cpsmar05.sas written by Jean Roth and downloaded from the
 NBER web site (http://www.nber.org/data/cps_progs.html) 11/8/05.

 Modifications:
  08/31/06  Create new comparison file for Baltimore, Cleveland, 
            Detroit, Milwaukee, New Orleans, Philadelphia, St. Louis, 
            and Washington, D.C.
...
%let year = 2005;
%let outlib = cps;
%let inpath = D:\DCData\Libraries\CPS\Raw\cpsmar05.zip;
%let infile = cpsmar05.dat;
%let out = &outlib..Cps_sup_&year._&month;

/*------------------------------------------------
  by Jean Roth	Tue Sep 13 11:57:54 EDT 2005
...
attrib  hptenure     length=3     label="";                                     
attrib  hplivqrt     length=3     label="";                                     
attrib  hptelhhd     length=3     label="";                                     
attrib  hptelavl     length=3     label="";                                     
attrib  hptelint     length=3     label="";                                     
...
attrib  a_vet        length=3     label="Veteran status";                       
...
attrib  ssi_yn       length=3     label="Item 57b - Did ... receiveSSI?";       
...
attrib  aprrp        length=3     label="Relationship to reference person";     
attrib  apparent     length=3     label="Parent's line number allocation flag"; 
attrib  apage        length=3     label="Age allocation flag";                  
attrib  apmaritl     length=3     label="Marital status allocation flag";       
attrib  apspouse     length=3     label="Spouse's line number allocation flag"; 
attrib  apsex        length=3     label="Sex allocation flag";                  
attrib  apvet        length=3     label="Veteran status allocation flag";       
attrib  aphga        length=3     label="Highest grade attended allocation flag";
attrib  aplfsr       length=3     label="Labor force status recode allocation"; 
attrib  aphrs        length=3     label="";                                     
attrib  apwhyabs     length=3     label="";                                     
attrib  appayabs     length=3     label="";                                     
attrib  apclswkr     length=3     label="";                                     
attrib  apnlflj      length=3     label="";                                     
attrib  apuslhrs     length=3     label="";                                     
attrib  aphrlywk     length=3     label="";                                     
attrib  prwernal     length=3     label="";                                     
attrib  prhernal     length=3     label="";                                     
attrib  apunmem      length=3     label="";                                     
attrib  apuncov      length=3     label="";                                     
attrib  apenrlw      length=3     label="";                                     
attrib  aphscol      length=3     label="";                                     
attrib  apftpt       length=3     label="";                                     
...
attrib  mig_cnt      length=3     label="Country of previous residence.";       
...
attrib  otyp_1       length=3     label="Covered by CHAMPUS.";                  
attrib  otyp_2       length=3     label="Covered by CHAMPVA.";                  
attrib  otyp_3       length=3     label="Covered by VA or military health care.";
...
attrib  paidccyn     length=3     label="Which children needed care while their";
...
attrib  statetax_b   length=4     label="State income tax liability, before";   
attrib  statetax_a   length=4     label="State income tax liability, after";    
...
LABEL
	...
	statetax_b= "State income tax liability, before"    
	statetax_a= "State income tax liability, after"     
...
******/
	...
	fedtax_bc  fedtax_bc.
	fedtax_ac  fedtax_ac.
	statetax_b statetax_b.
	statetax_a statetax_a.
	*****/
	m5g_cbst   m5g_cbst. 
	m5g_dscp   m5g_dscp. 
	m5gsame    m5gsame.  
...
filename datafile clear;     /***PT*** Added to clear fileref ******/



/***PT***
proc print data=library.cpsmar05 (obs=6);
*proc contents data=library.cpsmar05;
*****/
