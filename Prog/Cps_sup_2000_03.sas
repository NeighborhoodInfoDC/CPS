/**************************************************************************
 ...
 Description:  Read CPS March 2000 data.
...
/*by Jean Roth	Wed Oct  9 10:20:36 EDT 2002
  ...
  *  NOTE:  A value of -1 (or -1/# of decimals) usually indicates a missing value;
/*------------------------------------------------------------------------------------*/
...
PROC FORMAT cntlout=library.fcpmar00;

/*
The PROC FORMAT statement will store the formats in a sas data set called fcpmar00
To use the stored formats in a subsequent program, include something like this:

proc format cntlin=library.fcpmar00;
PROC freq;
        tables HUNDER15 ;
...
;
VALUE A_IND   	(default=32)
	0         =  "Old not in universe or children"
;
VALUE A_OCC   	(default=32)
	0         =  "Old not in universe or children"
;
...
VALUE APHGA   	(default=32)
	...
	4         =  "Allocated"                     
;
VALUE APRACE  	(default=32)
	0         =  "No change"                     
	4         =  "Allocated"                     
;
VALUE APORIGIN	(default=32)
	0         =  "No change"                     
	2         =  "Blank to value"                
	5         =  "Value to value"                
	8         =  "Blank to n/a code"             
...
VALUE APPAYABS	(default=32)
	...
	4         =  "Allocated"                     
;
VALUE APIND   	(default=32)
	0         =  "No change or children or armed"
	4         =  "Allocated"                     
;
VALUE APOCC   	(default=32)
	0         =  "No change or children or armed"
	4         =  "Allocated"                     
;
...
/***filename raw pipe "unzip -p /homes/data/cps/cpsmar00.zip  ";***/

data library.cpsmar00;
...
*INFILE '/home/data/cps/cpsmar00.raw' LRECL=1300 missover;
...
LABEL
	...
	HRET_YN   = "Recode - Retirement payments"          
	...
	HHINC     = "Recode -total household income"        
	...
	INDCCODE  = "Individually identified central city"  
	...
	MARSUPWT  = "March supplement final weight (2 impli"
	...
	WKSWORK   = "Item 33 - During 19.. in how many week"
	...
	PAW_TYP   = "Item 59c - Did ... receive AFDC or som"
	...
	APRACE    = "Race allocation flag"                  
	APORIGIN  = "Origin allocation flag"                
...
proc print data=library.cpsmar00 (obs=6);
...
FORMAT
	...
	I_NXTRES   I_NXTRES. 
;
proc contents data=library.cpsmar00;
run;
