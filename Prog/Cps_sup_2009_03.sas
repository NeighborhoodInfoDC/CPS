...
/*------------------------------------------------
  by Jean Roth	Mon Sep 28 16:57:00 EDT 2009
...
/* FILENAME datafile pipe "unzip -p /homes/data/cps/cpsmar09.zip "; */

*  The following line should contain the name of the SAS dataset ;

/* %let dataset = cpsmar09 ; */
...
attrib  pedisear     length=3     label="IS...DEAR OR DOES ...HAVE SERIOUS";    
...
LABEL
	...
	pedisear  = "IS...DEAR OR DOES ...HAVE SERIOUS"     
...
in a sas data set called fcpmar09 .
To use the stored formats in a subsequent program,
include something like this:

proc format cntlin=library.fcpmar09;
PROC freq;
        tables PULAYCK1 ;
...
/* proc print data=library.cpsmar09 (obs=6); */
...
/* proc contents data=library.cpsmar09; */
/*
